...
## ✍️ Descrição
Exemplificação de TODO LIST usando javascript/vanilla
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/todo-list-js.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/abPNJVd) 
